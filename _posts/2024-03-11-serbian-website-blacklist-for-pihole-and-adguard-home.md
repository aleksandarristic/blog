...
**Don't forget to visit the repository for details: <https://github.com/aleksandarristic/blacklist>**
...
If you haven't already heard about the [Bezbedan Balkan forum](https://bezbedanbalkan.net/thread-1.html), and you are interested in cybersecurity, osint, internet safety, privacy and other related topics - do go ahead and take a look at it. It's a valuable resource for everyone that wants to remain up-to-date in these topics regarding the whole Balkans. As a plus - there's some good people there that love this sort of work and they do it for free.
